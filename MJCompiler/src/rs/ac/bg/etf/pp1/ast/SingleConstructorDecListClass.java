...
public class SingleConstructorDecListClass extends ConstructorDecList {

    private ConstructorDecl ConstructorDecl;

    public SingleConstructorDecListClass (ConstructorDecl ConstructorDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("SingleConstructorDecListClass(\n");
