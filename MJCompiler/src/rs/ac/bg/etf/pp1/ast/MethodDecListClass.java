...
public class MethodDecListClass extends MethodDecList {

    private MethodDecList MethodDecList;
    private MethodDecl MethodDecl;

    public MethodDecListClass (MethodDecList MethodDecList, MethodDecl MethodDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MethodDecListClass(\n");
