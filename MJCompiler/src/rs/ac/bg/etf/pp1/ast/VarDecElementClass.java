...
public class VarDecElementClass extends VarDecElement {

    private String varName;
    private OptionalBrackets OptionalBrackets;

    public VarDecElementClass (String varName, OptionalBrackets OptionalBrackets) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("VarDecElementClass(\n");
